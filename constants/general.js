...
function TRANSACTION_PARTS(index) {
  let list = [
    { value: "CONTAINER", text: "Spesifikasi dan Layanan Kontainer" },
    { value: "DRIVER", text: "Driver dan Truck" },
    { value: "PAYMENT", text: "Metode Pembayaran" },
  ];
  return isFinite(index) ? list[index] : list;
}
